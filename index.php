        ...
        <div class="corpo">
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="imagens/São Paulo Carrossel.jpg" alt="São Paulo Camisa" width="1100" height="500">
                    </div>
            ...
            <div class="conteiner-prod">
                ...
                <div class="produto">
                    ...
                    <div class="text-prod">
                        ...
                        <br>
                        <p class="text-success">FRETE GRÁTIS</p>
                        <p class="preço1">R$ 329,99</p>
                        <p class="preço2">R$ 229,99</p>
                        <p class="preço3"> 7x de R$ 32,86 </p>
                ...
                <div class="produto">
                    ...
                    <div class="text-prod">
                        ...
                        <p class="preço3">4x de R$ 32,50</p>
            ...
            <div class="produto">
                ...
                <div class="text-prod">
                    <p class="prod-paragrafo">Whey Protein Optimum Nutrition 100% Whey Gold Standard - Chocolate Mint -
                        2,27kg</p>
                    <p class="text-success">FRETE GRÁTIS</p>
                    <p class="preço1">R$ 819,54</p>
                    <p class="preço2">R$ 710,11</p>
                    <p class="preço3">12x de R$ 59,18</p>
            ...
            <div class="produto">
                ...
                <div class="text-prod">
                    ...
                    <br><br><br>
                    <p class="text-success">FRETE GRÁTIS</p>
                    <p class="preço1">R$ 159,99</p>
                    <p class="preço2">R$ 119,99</p>
                    <p class="preço3">4x de R$ 30,00</p>
            ...
            <div class="produto">
                ...
                <div class="text-prod">
                    ...
                    <br><br>
                    <p class="text-success">FRETE GRÁTIS</p>
                    <p class="preço1">R$ 259,99</p>
                    <p class="preço2">R$ 199,00</p>
                    <p class="preço3">6x de R$ 33,17</p>
            ...
            <div class="produto">
                ...
                <div class="text-prod">
                    ...
                    <p class="text-success">FRETE GRÁTIS</p>
                    <p class="preço1">R$ 279,99</p>
                    <p class="preço2">R$ 199,99
                    </p>
                    <p class="preço3">6x de R$ 33,33</p>
            ...
            <br>
            <br>
            <h1 class="Titulo">Camisetas de Futebol é na BP Esportes</h1>
            <br>
            <br>
