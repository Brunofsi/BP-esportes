...
<body>
    ...
    <div class="topnav nav justify-content-end">
        ...
        <div style="color:pink; float:left; margin:1%;">
            <?php print_r('Bem vindo, '.$_SESSION['user']); ?>
        </div>
    ...
    <div class="principal">
     ...
     <div class="car">
        ...
        <h3 class="bg-dark text-white" style="text-align: center;"><strong>Meu carrinho</strong></h3>
    <thead>
      <tr>
      <th width="200"></th>
    ...
    <tfoot>
      <tr>
        <td><input type="submit" class="btn btn-success" value="Atualizar Carrinho" /></td>
        <td ><a class="btn btn-secondary"  href="../index.php">Continuar Comprando</a></td>
        <td ><a class="btn btn-warning"  href="#">Finalizar</a></td>
      <tr>
        ...
        <tr>
          <td colspan="5">Não há produto no carrinho</td>
                ...
                foreach($_SESSION['carrinho'] as $id => $qtd){
                        ...
                        $x=(double)$ln['valor'];
                        $y=(double)$qtd;
                        $preco = number_format($x, 2, ',', '.');
                        $sub   = number_format($x * $y, 2, ',', '.');
                        $total += $x* $y;
                         echo '<tr>
                 <td class="tdI"> <img class="imgCar"  src="../imagens/'.$ln['nome'].'.png" /> </td>
                <td>'.$nome.'</td>
                <td><input type="text" size="3" name="prod['.$id.']" value="'.$y.'" /></td>
                <td>R$ '.$preco.'</td>
                <td>R$ '.$sub.'</td>
                ...
                echo '<tr>
              <td colspan="4" class="bg-info text-white">Total: </td>
              <td class="bg-info text-white"><h6>R$ '.$total.'</h6></td>
                    </tr>';
          }
                   ?>
         </tbody>
