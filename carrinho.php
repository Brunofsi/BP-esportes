...
<body>
    ...
    <div class="principal">
     ...
     <div class="car">
        ...
        <p class="bg-dark text-white" style="text-align: center;"><strong>Meu carrinho</strong>
    <thead>
      <tr>
      <th width="200"></th>
    ...
    <tfoot>
      ...
      <tr>
      <td colspan="5" class="btn btn-danger"><a href="index.php" >Continuar Comprando</a></td>
    </tfoot>
    <tbody>
     <?php
        ...
        <tr>
          <td colspan="5">Não há produto no carrinho</td>
              ...
              <td class="bg-info text-white">R$ '.$total.'</td>
                    </tr>';
          }
                   ?>
         </tbody>
