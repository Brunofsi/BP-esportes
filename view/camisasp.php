        ...
        <div class="corpo">
            ...
            <div class="esq">
                <div class="text-prod">
                    ...
                    <p class="preço2">R$ 229,99</p>
                    <p class="preço3">7x R$ 32,86</p>
                    <div class="dropdown">
            ...
            <div class="meio">
               <div onclick="myFunction()"><img src="../imagens/SãoPauloFrente.png" width="20%" class="foto">
                </div>
                <div onclick="myFunction2()"><img src="../imagens/SãoPauloCosta.png" width="20%" class="foto">
                </div>
                <div class="img-Principal" id="a1"><div class="zoom"><img src="../imagens/SãoPauloFrente.png" width="100%"></div></div>
                <div class="img-Principal" id="a2" style="display: none;"><div class="zoom"><img src="../imagens/SãoPauloCosta.png"
                    width="100%"></div></div>
            </div>
            <div class="dir">
                <p class="titulo">Camisa do São Paulo I 2021 adidas - Masculina</p>
            ...
            <div class="row2">
                <div class="column2">
                    <img src="../imagens/SaoPaulo01.jpg" alt="Paul Pogba" style="width:100%"
                        onclick="myFunction3(this);">
                </div>
                <div class="column2">
                    <img src="../imagens/SaoPaulo02.png" alt="Paul and Baily" style="width:100%"
                        onclick="myFunction3(this);">
                </div>
                <div class="column2">
                    <img src="../imagens/SaoPaulo03.jpg" alt="Rash and Mactominay" style="width:100%"
                        onclick="myFunction3(this);">
                </div>
                <div class="column2">
                    <img src="../imagens/SaoPaulo04.jpg" alt="Bruno" style="width:100%"
                        onclick="myFunction3(this);">
                </div>
            </div>
            ...
            <div>
                ...
                <br>
                <p class="pp">De São Paulo tens o nome! Há 30 anos, Tele Santana comemorava seu primeiro título comandando o Tricolor. Homenageando esse marco que depois se tornaria uma jornada de títulos e glórias, a Adidas lança a Camisa São Paulo Masculina para a temporada 21/22. Semelhante ao manto que os craques usam nas partidas, o modelo é produzido com tecido leve e respirável predominantemente branco com as listras tricolores tradicionais. O escudo do amado clube brasileiro aparece bordado na altura do peito e deixa evidente sua torcida dentro e fora dos estádios.
                </p>
                <br>
                <div class="desc-esq">
                    <strong>Nome:</strong> Camisa do São Paulo I 2021 adidas - Masculina
                    <br>
                    <strong>Gênero:</strong> Masculino
                    <br>
                    <strong>Indicado para:</strong> Jogo
                    <br>
                    <strong>Clube:</strong> Nacional
                    <br>
                    <strong>Time:</strong> São Paulo SP
                    <br>
                    <strong>Gola:</strong> Gola V
                    <br>
                </div>
                <div class="desc-esq">

                    <strong>Material:</strong> Poliéster Reciclado
                    <br>
                ...
                <div class="desc-esq">
                    <strong>Patrocínio</strong>: Sem patrocínio
                    <br>
                    <strong>Composição:</strong> 100% Poliéster Reciclado
                    <br>
